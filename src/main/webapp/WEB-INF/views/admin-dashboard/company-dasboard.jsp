  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      <div class="mdc-drawer__header">
        <a href="/companyDashboard" class="brand-logo">
      ...
      <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" onClick="getProjectListTable()">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" onClick="getTaskListTable()">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">grid_on</i>
                Task
              </a>
            </div>
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" onClick="getRoleAndTaskTable()">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">pie_chart_outlined</i>
                Roles & Task
              </a>
            </div>
    ...
    <div class="main-wrapper mdc-drawer-app-content">
                ...
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    ...
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                      ...
                      <h6 class="item-subject font-weight-normal"><a onclick="logout()">Logout</a></h6>
      ...
      <div id="adminDashboardRightPanal">
     	 <jsp:include page="overview/admin-overview.jsp"></jsp:include>
      </div>
      <jsp:include page="../portal-hidden-fields.jsp"></jsp:include>
    </div>
  </div>
  <!-- plugins:js -->
