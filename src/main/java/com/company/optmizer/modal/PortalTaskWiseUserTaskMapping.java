...
@Entity
@Table(name = "portal_task_wise_user_task_mapping")
public class PortalTaskWiseUserTaskMapping {
	@Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "task_wise_user_task_id")
    private Long taskWiseUserTaskId;
	
	@Column(name = "task_wise_role_task_id")
    private Long taskId;
	
	@Column(name = "task_wise_role_task_cost")
	...
	public Long getTaskWiseUserTaskId() {
		return taskWiseUserTaskId;
	}
	public void setTaskWiseUserTaskId(Long taskWiseUserTaskId) {
		this.taskWiseUserTaskId = taskWiseUserTaskId;
	}
